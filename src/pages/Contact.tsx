...
const contactInfo = [
  {
    icon: MapPin,
    title: "Alamat",
    details: ["Jl. Pendidikan Islam No. 123", "Kota, Provinsi 12345"],
  },
  {
    icon: Phone,
    title: "Telepon",
  ...
  },
  {
    icon: Mail,
    title: "Email",
    details: ["info@baetelanshar.sch.id", "pendaftaran@baetelanshar.sch.id"],
  },
  {
    icon: Clock,
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <div className="mt-10 aspect-video rounded-2xl overflow-hidden bg-muted">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.666379034878!2d106.82496931536905!3d-6.175110395517425!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2e764b12d%3A0x3d2ad6e1e0e9bcc8!2sNational%20Monument!5e0!3m2!1sen!2sid!4v1625647474098!5m2!1sen!2sid"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
